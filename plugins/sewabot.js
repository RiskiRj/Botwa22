    ...
    if(!args[0]) {
        conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
            "listMessage": {
              ...
              "description": "Berikut ini adalah daftar harga Ganz Bot.",
              "footerText": "Silahkan tekan tombol \"Click Here\" untuk melihat daftar harga Ganz Bot.\n\nJika ada pertanyaan atau semacamnya silahkan hubungi owner.",
