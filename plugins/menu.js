    ...
    if (teks == '404') {
      return conn.relayWAMessage(conn.prepareMessageFromContent(m.chat, {
        "listMessage": {
          ...
          "description": "Berikut ini adalah daftar menu Ganzbot .",
          "footerText": "Silahkan tekan tombol \"Click Here\" untuk melihat sub-menu GanzBot.\n\nJika menemukan bug, error atau kesulitan dalam penggunaan silahkan laporkan/tanyakan kepada owner.",
          ...
          "sections": [
            {
              "rows": [{
                ...
                "title": "Group Official Ganzbot dan haruno bot",
