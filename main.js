...
conn.browserDescription = [ 'Ganzbot by riski', 'ie', '9.7']
...
global.reloadHandler = function () {
  ...
  conn.welcome = 'Hai, @user!\nSelamat datang di grup jangan jadi beban @subject\n\n@desc'
  conn.bye = 'yah si beban keluar  @user'
  conn.spromote = '@user sekarang admin'
  conn.sdemote = '@user sekarang bukan admin yahahaha kasihan ðŸ—¿'
